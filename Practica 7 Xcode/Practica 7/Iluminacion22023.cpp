...
//    pointLightCount++;
  ...
  spotLightCount++;
    ...
    while (!mainWindow.getShouldClose()) {
        ...
        spotLights[1].SetPos(glm::vec3(0.0f + mainWindow.getMovimientoAuto(), 0.0, 0.0f));
        ...
        model = glm::mat4(1.0);
        model = glm::translate(model, glm::vec3(mainWindow.getMovimientoAuto(), 15.0f + mainWindow.getMovimientoHelicoptero(), -1.0));
        model = glm::scale(model, glm::vec3(2.f, 2.f, 2.f));
        model = glm::rotate(model, -90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
        model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
        spotLights[2].SetPos(glm::vec3(mainWindow.getMovimientoAuto(), mainWindow.getMovimientoHelicoptero(), 0.0f));
        glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
        ...
        // Carroceria
        model = glm::mat4(1.0);
        model = glm::translate(model, glm::vec3(mainWindow.getMovimientoAuto(), 0.f, 0.f)); // Movimiento del auto
